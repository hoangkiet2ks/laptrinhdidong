...
const medicines = [
  ...
  },
  {
    ...
    star: "4.9",
    description:
      "Used to alleviate mild to moderate pain such as headaches, toothaches...",
...
const Screen_1 = () => {
  ...
  useEffect(() => {
    fetch("http://192.168.15.1:3000/api/items")
      .then((res) => res.json())
      ...
      <View style={styles.container}>
        ...
        <View style={styles.bottomNav}>
          <TouchableOpacity style={styles.navItem}>
            <Image
              source={require("../assets/anh09.png")}
          ...
          <TouchableOpacity style={styles.navItem}>
            <Image
              source={require("../assets/anh12.png")}
              style={styles.navicon}
            />
          ...
          <TouchableOpacity style={styles.navItem}>
            <Image
              source={require("../assets/anh13.png")}
              style={styles.navicon}
            />
          ...
          <TouchableOpacity style={styles.navItem}>
            <Image
              source={require("../assets/anh14.png")}
              style={styles.navicon}
            />
